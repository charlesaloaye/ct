    ...
    <div className="container">
        <div className="about-me">
            <div className="row align-items-start">
                ...
                {experience.map((exp, index) => <ExperienceCard key={index} company={exp.company} description={exp.description} fromYear={exp.fromYear} location={exp.location} icon={exp.icon} role={exp.role} toYear={exp.toYear}/>)}
                </div>
                <div className="col-lg-7 sticky-lg-top ps-xl-5">
                    <div className="row align-items-start">
                        <div className="col-md-7 py-4">
                            <div className="about-me-img">
                                <Image className='w-full h-auto' width={500} height={400} src="/assets/img/charlestechy1.jpg" title={process.env.NEXT_PUBLIC_APP_NAME} 
