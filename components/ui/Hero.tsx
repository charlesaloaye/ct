        ...
        <div className="row align-items-center min-vh-100 flex-row-reverse">
            <div className="col-lg-6 ps-xl-5 mb-5 mb-lg-0">
                <div className="home-intro">
                    ...
                    <h2>I&lsquo;m a <Typewriter /></h2>
                    <p className="pe-lg-5">{process.env.NEXT_PUBLIC_HERO_TEXT}</p>
                    <div className="btn-bar">
                        <Link target="_blank" className="px-btn px-btn-theme" href="/resume/charlesaloaye.pdf" download={true}>Download cv 

                        &nbsp;<BiDownload className="inline ml-5"/> 
            ...
            <div className="col-lg-6">
                <div className="home-image text-center">
                    ...
                    <Image width={500} height={400} className="md:hidden w-full h-auto" src="/assets/img/charlestechy1.jpg?rand" title={process.env.NEXT_PUBLIC_APP_NAME} alt={`${process.env.NEXT_PUBLIC_APP_NAME}`} />
